...
Implement only your bounded assignment. As an independent Opus 5.5 or GPT-6 Sol reviewer, fix your findings yourself, re-review the final candidate, integrate through permitted repository operations and update/close the assigned issue. Write only your own assigned issue's board row at your own transitions, as the no-choke-point rules in agent coordination describe; do not edit any other row or shared project field. Return a completion summary asking the orchestrator to reconcile shared board state and dependencies, release your session, clean the completed worktree and refill open lanes.
