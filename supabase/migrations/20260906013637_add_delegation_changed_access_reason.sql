-- Delegation changes affect management authority, not personal use or the
-- separately modelled record-sharing Access Grant. Extend the current/stored
-- V1 vocabulary without rewriting historical rows or changing Team mapping.
