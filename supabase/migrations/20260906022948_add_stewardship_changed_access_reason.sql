-- Stewardship adoption atomically creates the minimum role, assignment,
-- delegation and adoption marker. Record that one coordinated Access change
-- without adding another ordering mechanism or rewriting stored V1 history.
