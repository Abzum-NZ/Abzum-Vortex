-- #1134: register the four builder permissions as platform catalogue release 1.4.0
...
-- not edited.
--
-- The live exact-revision checker and the live platform initializer are restated in full
-- with revision 6 added, so their identities, grants and callers are unchanged. Every
-- function below is identical to its canonical file under supabase/schemas/vortex_access.
