-- Record ownership changes invalidate Access like other protected record facts.
-- Preserve the established Access-version writer and add only this closed reason.
