-- Extend the transaction-bound permission evaluator with current delegation
-- coverage for management scopes. This remains private eligibility evidence,
-- not a final protected-operation allow result.
