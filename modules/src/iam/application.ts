...
const roles = [
  {
    ...
    permissions: [
      ...
      "vortex.iam.core.access_request.create",
      "vortex.iam.core.access_request.read",
      "vortex.iam.core.access_request.update",
      "vortex.iam.core.access_request.soft_delete",
      "vortex.iam.core.access_request_item.create",
      "vortex.iam.core.access_request_item.read",
      "vortex.iam.core.access_review.read",
      "vortex.iam.core.access_review_response.read",
    ],
  },
  {
    ...
    permissions: [
      ...
      "vortex.iam.core.access_request.read",
      "vortex.iam.core.access_review.create",
      "vortex.iam.core.access_review.read",
      "vortex.iam.core.access_review.update",
      "vortex.iam.core.access_review_response.create",
      "vortex.iam.core.access_review_response.read",
      "vortex.iam.core.access_review_response.update",
    ],
  },
  {
    ...
    body: {
          ...
          children: [
            {
              ...
              permission: "vortex.iam.core.access_request.read",
            },
            {
              id: "nav_iam_reviews",
              type: "page",
              label: "Reviews",
              page: "iam_reviews",
              permission: "vortex.iam.core.access_review.read",
            },
          ],
        },
        {
      ...
      pages: [
            ...
            main: slot(
              {
                ...
                iam_overview_summary: placement(SUMMARY_VALUES_BLOCK_RELEASE, {
                  title: textValue("My access activity"),
                }),
              },
              ["iam_overview_heading", "iam_overview_summary"],
            ),
          },
        },
        {
        ...
        },
        {
          ...
          type: "form",
          record_type: "vortex.iam.core:access_request",
          permission: "vortex.iam.core.access_request.create",
        ...
        },
        {
          ...
          type: "form",
          record_type: "vortex.iam.core:access_request",
          permission: "vortex.iam.core.access_request.update",
        ...
        },
        {
          ...
          type: "form",
          record_type: "vortex.iam.core:access_review",
          permission: "vortex.iam.core.access_review.create",
          ...
          composition: formComposition("iam_review_new_form", "Record review decision", [
            ...
            textInput(
              "iam_review_new_evidence",
              "workflow_evidence",
              "Protected human-input evidence",
            ),
