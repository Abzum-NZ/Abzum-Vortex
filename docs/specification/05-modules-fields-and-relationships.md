...
| `link`                   | Link to one record type, including the People or Group system record type | Target, delete behaviour, reverse name, optional application-access requirement          |
