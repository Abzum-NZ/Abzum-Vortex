...
| --- | --- | --- |
| People | Read-only system record type for organisation accounts and Group membership; requester and beneficiary links | Existing [Identity](../02-people-organisations-and-sign-in.md) and [Access](../04-access-and-permissions.md) facts, not a copied user directory |
