...
- Completed repository boundaries [#10](https://github.com/Abzum-NZ/Abzum-Vortex/issues/10) and identifier/reference contracts [#11](https://github.com/Abzum-NZ/Abzum-Vortex/issues/11) through [PR #178](https://github.com/Abzum-NZ/Abzum-Vortex/pull/178) and [PR #179](https://github.com/Abzum-NZ/Abzum-Vortex/pull/179); moved complete domain contracts [#12](https://github.com/Abzum-NZ/Abzum-Vortex/issues/12) to Ready, rewrote [#12–#15 and #17](https://github.com/Abzum-NZ/Abzum-Vortex/issues/12) against Specification 2.0, and recorded release-number ownership as [D37](decisions.md#d37--who-sets-a-module-or-application-release-number).
