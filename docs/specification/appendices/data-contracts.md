...
The Group's organisation, identity and key remain permanent; its display label may change. Retiring a Group does not release its key for a different Group or erase the source identities needed to explain earlier assignments.
