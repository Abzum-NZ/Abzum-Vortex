...
order. These are candidate contracts until their complete compile, publication,
consumer-read and restore proof passes; parsing a graph alone does not make it
executable. The [shared graph delivery plan](../../build-plan/issue-58-shared-rule-graph-foundation.md)
tracks that proof before interpreter implementation. The other interactive and
