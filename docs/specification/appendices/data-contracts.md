...
Current collective-principal contracts use Group identities and the `group` discriminator. Definition ownership, Access reasons and current readers/writers use that same vocabulary under [#283](https://github.com/Abzum-NZ/Abzum-Vortex/issues/283). Remove Team translation adapters; there is no second collective-principal concept.
