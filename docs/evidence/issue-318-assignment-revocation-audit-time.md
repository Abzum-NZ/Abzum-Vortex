...
- Six-schema lint reports no errors, retaining three older Access warnings and the five already-reviewed generic immutable/JSON construction warnings documented in [condition parity evidence](issue-36-record-visibility.md). Security advisors report no warnings or errors.
