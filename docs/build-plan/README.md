...
The native V2 compiler and the stored V1 permission handoff merged into Testing in [PR #341](https://github.com/Abzum-NZ/Abzum-Vortex/pull/341), with independent review, clean-source verification and verified hosted Testing evidence. Native change assessment then merged in [PR #342](https://github.com/Abzum-NZ/Abzum-Vortex/pull/342), with [comparison evidence](../evidence/issue-249-native-version-impact.md); its hosted result is not yet inspected. Continue with [native draft and identity storage](issue-249-native-draft-storage.md), then coordinated publication/readback in [#249](https://github.com/Abzum-NZ/Abzum-Vortex/issues/249). [#38](https://github.com/Abzum-NZ/Abzum-Vortex/issues/38) depends on that final V2 integration, not on the whole designer.
