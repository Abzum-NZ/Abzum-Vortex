...
| [Row-policy composition #35](https://github.com/Abzum-NZ/Abzum-Vortex/issues/35)             | Combined action permission and row restriction through actual non-owner database roles                                                  | Current: fresh implementation from current source (earlier local candidate set aside, not recovered), then final SQL integration and delivery; no fixed application-size permission cap; #45 is not a prerequisite                                                                                                                                     |
