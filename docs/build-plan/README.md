...
| [Page and capability projection #38](https://github.com/Abzum-NZ/Abzum-Vortex/issues/38)     | Only permitted pages, shared layouts, nested content and controls appear in the shared interface description                            | Exact V1/V2 stored handoff and shared-layout projection are independently reviewed; [delivery evidence](../evidence/issue-38-native-page-handoff.md) tracks normal source and hosted verification. [#64](https://github.com/Abzum-NZ/Abzum-Vortex/issues/64) owns installed runtime use; conversion/designer work is not a prerequisite. |
