...
The completed [#36](https://github.com/Abzum-NZ/Abzum-Vortex/issues/36) and [#40](https://github.com/Abzum-NZ/Abzum-Vortex/issues/40) work supplies the record and administration decisions now consumed by [row-policy composition #35](https://github.com/Abzum-NZ/Abzum-Vortex/issues/35). #35 still needs narrow SQL tool-execution authorization at the fixed 1,000-permission cutoff/recursion bound, final SQL integration and delivery; do not treat it as a reason to reopen #36 or #40. [Field and action restrictions #37](https://github.com/Abzum-NZ/Abzum-Vortex/issues/37) has verified catalogue and [PR #337](https://github.com/Abzum-NZ/Abzum-Vortex/pull/337) hosted receipts. [PR #338](https://github.com/Abzum-NZ/Abzum-Vortex/pull/338) also has a verified exact hosted success receipt. Its neutral field/sharing SQL review has 88 local assertions and remains undelivered pending #35. [Page and capability projection #38](https://github.com/Abzum-NZ/Abzum-Vortex/issues/38) delivered its contract checkpoint through [PR #339](https://github.com/Abzum-NZ/Abzum-Vortex/pull/339); its separately reviewed projector and callback seam merged through [PR #340](https://github.com/Abzum-NZ/Abzum-Vortex/pull/340), but are not connected to a working page route.

The native V2 compiler and the stored V1 permission handoff merged into Testing in [PR #341](https://github.com/Abzum-NZ/Abzum-Vortex/pull/341), with independent review and clean-source verification. [Compiler evidence](../evidence/issue-249-native-application-compiler.md) distinguishes that delivered slice from the unfinished V2 version-impact and publication/read pipeline in [#249](https://github.com/Abzum-NZ/Abzum-Vortex/issues/249). Complete version-impact comparison next, then coordinated publication/readback. [#38](https://github.com/Abzum-NZ/Abzum-Vortex/issues/38) depends on that final V2 integration, not on the whole designer. Hosted verification of PR #341 has not yet been inspected.
...
| [Row-policy composition #35](https://github.com/Abzum-NZ/Abzum-Vortex/issues/35)             | Combined action permission and row restriction through actual non-owner database roles                                                  | Current: tool-execution authorization needs the fixed 1,000-permission cutoff/recursion bound, then final SQL integration and delivery; #45 is not a prerequisite |
| [Field and action restrictions #37](https://github.com/Abzum-NZ/Abzum-Vortex/issues/37)       | Readable/changeable fields and action inputs cannot exceed current permitted scope; local sharing cannot grant fields the grantor lacks | Catalogue and PR #337/#338 exact hosted receipts verified; neutral field/sharing SQL review remains undelivered pending #35 |
...
| [Page and capability projection #38](https://github.com/Abzum-NZ/Abzum-Vortex/issues/38)     | Only permitted pages, sections, blocks and controls appear in the shared interface description                                          | Reviewed projector and stored V1 permission handoff merged; [#249](https://github.com/Abzum-NZ/Abzum-Vortex/issues/249) still owns V2 publication/readback and [#64](https://github.com/Abzum-NZ/Abzum-Vortex/issues/64) owns the real installed consumer |
...
| [Access activity integration #41](https://github.com/Abzum-NZ/Abzum-Vortex/issues/41)        | Permission changes and refused operations use the shared content-free history                                                           | [Reviewed implementation plan](issue-41-access-activity.md) retains existing completed events; the new fixed runtime-only refusal writer is stopped by tool authorization, not a business decision or missing technical dependency |
