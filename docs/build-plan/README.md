...
Next deliver the exact management-application requirement (D2) using the same current requirement and existing sealed role entries. Binding activation/replacement is revision-checked; required continuously accepted permissions may remain usable while unrelated additions await acceptance. Compose the safeguard with actual application-access changes. Installation and the human journey remain [#64](https://github.com/Abzum-NZ/Abzum-Vortex/issues/64) and [#267](https://github.com/Abzum-NZ/Abzum-Vortex/issues/267), not a claim that private stewardship facts create an interface. Invitation integration follows D2; the sole effective-access decision and authorised invocation remain [#34](https://github.com/Abzum-NZ/Abzum-Vortex/issues/34) and [#40](https://github.com/Abzum-NZ/Abzum-Vortex/issues/40). See the [stewardship contract](../specification/appendices/data-contracts.md#permission-and-role-contracts) and [setup/removal behaviour](../specification/appendices/iam-application.md#setup-and-removal).
