...
The V2 compiler/publication pipeline is still missing. Its engine-first compiler slice in [#249](https://github.com/Abzum-NZ/Abzum-Vortex/issues/249) is running in parallel; #38 depends on it only for final V2 compiler/publication integration, not for the whole designer.
...
| [Page and capability projection #38](https://github.com/Abzum-NZ/Abzum-Vortex/issues/38)     | Only permitted pages, sections, blocks and controls appear in the shared interface description                                          | Reviewed contract/projector checkpoints merged; registered reader integration remains; [#249](https://github.com/Abzum-NZ/Abzum-Vortex/issues/249) is required only for final V2 compiler/publication integration |
