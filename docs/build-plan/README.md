...
The [App Designer HTML prototype](app-designer-html-prototype.md) precedes production App Designer UI implementation, but both follow the [complete file-defined application proof](definition-first-application-proof.md). Preserve the existing prototype without expanding it during engine delivery. Current Phase 3 implementation is [row enforcement #35](https://github.com/Abzum-NZ/Abzum-Vortex/issues/35): the [record visibility #36](https://github.com/Abzum-NZ/Abzum-Vortex/issues/36) source and available [access administration #40](https://github.com/Abzum-NZ/Abzum-Vortex/issues/40) compositions have been delivered to Testing. Their unverified hosted receipts remain outstanding, not new dependencies blocking #35's local work. The removal-only withdrawn-assignment cleanup approved on 8 September is independently reviewed and locally verified in [PR #334](https://github.com/Abzum-NZ/Abzum-Vortex/pull/334), without restoring or increasing authority; normal delivery and hosted verification are recorded separately. The eventual designer and MCP authoring use the same protected definition operations and proven runtime.
...
[Activity foundation #252](issue-252-activity-foundation.md) is complete: independently reviewed, merged into Testing through [PR #310](https://github.com/Abzum-NZ/Abzum-Vortex/pull/310), and matched to its successful [exact hosted receipt](../evidence/issue-252-activity-foundation.md#hosted-delivery--6-september-2026). The shared private append boundary records successful changes atomically and supports content-free refusal after rollback. [#115](https://github.com/Abzum-NZ/Abzum-Vortex/issues/115) owns later permitted views and full service coverage. Its dependent #36 and #40 implementation is underway: record-scope contracts and compiler mapping have passed independent review and local verification, and the [first Access-administration checkpoint](../evidence/issue-40-access-administration.md) has passed local Group-read and competing-change checks. Both full tasks remain open.
...
The shared-condition, permission-scope preservation, Group membership reads and protected Group creation/rename checkpoints merged normally into Testing through [PR #313](https://github.com/Abzum-NZ/Abzum-Vortex/pull/313) and [PR #314](https://github.com/Abzum-NZ/Abzum-Vortex/pull/314). Application-owned saved-condition compilation and the narrowly scoped [invitation correction #315](https://github.com/Abzum-NZ/Abzum-Vortex/issues/315) followed in [PR #316](https://github.com/Abzum-NZ/Abzum-Vortex/pull/316). Registered permission browsing and private PostgreSQL condition parity are now delivered as reviewed source through [PR #317](https://github.com/Abzum-NZ/Abzum-Vortex/pull/317) and [PR #319](https://github.com/Abzum-NZ/Abzum-Vortex/pull/319). [Visibility evidence](../evidence/issue-36-record-visibility.md) and [administration evidence](../evidence/issue-40-access-administration.md) distinguish local proof and source merges from still-unverified hosted database receipts.

The explicit person/current-account parameter correction, separate local-role/template reads and [assignment-revocation audit correction #318](https://github.com/Abzum-NZ/Abzum-Vortex/issues/318) merged as reviewed source in [PR #320](https://github.com/Abzum-NZ/Abzum-Vortex/pull/320). The repair preserves real expiry, revisions and stewardship; it adds no clock investigation or infrastructure work and does not reopen approved [#33](https://github.com/Abzum-NZ/Abzum-Vortex/issues/33). Exact hosted receipts remain distinct from those source merges.

The [role-assignment/delegation ledger within #40](issue-40-protected-access-administration.md#next-safe-read-checkpoint-role-assignments-and-delegation-authorities) and [direct-account/current-Group ownership checkpoint within #36](issue-36-ownership-and-visibility.md#c--next-ownership-checkpoint-all-record-account-and-current-group-routes) are implemented, independently reviewed and locally verified. The next bounded work is activation administration reads and the remaining local-share/inherited-parent/relationship restrictions, followed by their protected changes. Complete row/field enforcement still depends on those remaining outcomes; the neutral ownership fixture is not a shipping record policy.
...
| [Row-policy composition #35](issue-35-row-policy-composition.md)                             | Combined action permission and row restriction through actual non-owner database roles                                                  | After #36; generated-table installation belongs to #45, not a prerequisite here                                                 |
| [Field and action restrictions #37](issue-37-field-access.md)                                | Readable/changeable fields and action inputs cannot exceed current permitted scope; local sharing cannot grant fields the grantor lacks | After #35/#36 and completed #34; pure contract preparation may overlap #35, but full invocation needs its final record decision |
| [Protected Access administration #40](issue-40-protected-access-administration.md)           | Authority-checked invocation and safe read models over existing role, Group and assignment operations                                   | After #252 and completed catalogue/fact/decision foundations; can progress alongside #36                                        |
| [Assignment-revocation correction #318](https://github.com/Abzum-NZ/Abzum-Vortex/issues/318) | A valid access removal is not rejected by an earlier audit-time observation                                                             | After completed #33; independent of unfinished visibility and role-reader work                                                  |
| [Page and capability projection #38](https://github.com/Abzum-NZ/Abzum-Vortex/issues/38)     | Only permitted pages, sections, blocks and controls appear in the shared interface description                                          | Uses completed #32/#34; consumes only available page contracts and refuses unsupported policy                                   |
| [Permission-aware caching #39](https://github.com/Abzum-NZ/Abzum-Vortex/issues/39)           | Any cached result preserves exact organisation/account scope, current authority and expiry                                              | Uses #34 and the existing Access version; no duplicate counter                                                                  |
| [Access activity integration #41](https://github.com/Abzum-NZ/Abzum-Vortex/issues/41)        | Permission changes and refused operations use the shared content-free history                                                           | Uses #252 and actual owning operations; foundation storage alone is not integration                                             |
