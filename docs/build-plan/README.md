...
The completed [#36](https://github.com/Abzum-NZ/Abzum-Vortex/issues/36) and [#40](https://github.com/Abzum-NZ/Abzum-Vortex/issues/40) work supplies the record and administration decisions now consumed by [row-policy composition #35](https://github.com/Abzum-NZ/Abzum-Vortex/issues/35). #35 still needs narrow SQL tool-execution authorization at the fixed 1,000-permission cutoff/recursion bound, final SQL integration and delivery; do not treat it as a reason to reopen #36 or #40. [Field and action restrictions #37](https://github.com/Abzum-NZ/Abzum-Vortex/issues/37) has a verified catalogue hosted receipt; later source checkpoints [PR #337](https://github.com/Abzum-NZ/Abzum-Vortex/pull/337) and [PR #338](https://github.com/Abzum-NZ/Abzum-Vortex/pull/338) are merged, while their hosted receipts are not yet verified. Its neutral field/sharing SQL review has 88 local assertions and remains undelivered pending #35. [Page and capability projection #38](https://github.com/Abzum-NZ/Abzum-Vortex/issues/38) has started its available independent contract/projector slice.
...
| [Page and capability projection #38](https://github.com/Abzum-NZ/Abzum-Vortex/issues/38)     | Only permitted pages, sections, blocks and controls appear in the shared interface description                                          | Started independent contract/projector slice using completed #32/#34; [#249](https://github.com/Abzum-NZ/Abzum-Vortex/issues/249) is required only for final V2 compiler/publication integration |
