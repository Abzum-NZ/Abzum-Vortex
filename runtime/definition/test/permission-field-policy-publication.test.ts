...
// #37: the two field-policy rules that are owned at publication, tested in the
// compiler/semantic layer here and at the append-release database boundary in
// SQL472. Field bounds are
...
// no notion of record-type membership or of sensitivity. The existing
// permission_field_policy_is_valid function validates canonical shape, while
// append_release validates exact record-type ownership before storage and
// registration requires equality with the published permissions. The
// compiler remains the source-facing validator:
