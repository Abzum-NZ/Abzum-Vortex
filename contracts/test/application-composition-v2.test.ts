...
const catalogueSnapshotV2 = {
  ...
  platformBlocks: {
    ...
    releases: [
      ...
      {
        blockId: blockTwo.blockId,
        key: "vortex.block.content",
        releaseVersion: blockTwo.releaseVersion,
        contentFingerprint: blockTwo.contentFingerprint,
        catalogueFingerprint: blockTwo.catalogueFingerprint,
        name: "Content",
        icon: "panel-top",
