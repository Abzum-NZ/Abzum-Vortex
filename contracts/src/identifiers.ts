...
export const teamIdSchema = stableId<"TeamId">();
...
export const approvalRequestIdSchema = stableId<"ApprovalRequestId">();
export const approvalDecisionIdSchema = stableId<"ApprovalDecisionId">();
...
export const subscriptionIdSchema = stableId<"SubscriptionId">();
export const usageEntryIdSchema = stableId<"UsageEntryId">();
export const announcementIdSchema = stableId<"AnnouncementId">();
...
export type UsageEntryId = z.infer<typeof usageEntryIdSchema>;
