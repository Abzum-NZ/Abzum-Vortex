            ...
            .array(
              z
                .object({
                  key: builderKeySchema,
                  label: labelSchema,
                  entry_actions: z.array(namespacedKeySchema).max(100),
                  exit_actions: z.array(namespacedKeySchema).max(100),
                  entry_workflows: z.array(builderKeySchema).max(100),
                  exit_workflows: z.array(builderKeySchema).max(100),
                })
                .strict(),
            )
            .min(1)
    ...
    actions: z.array(
      z
        .object({
          ...
          inputs: z.array(actionInputSchema).max(100),
